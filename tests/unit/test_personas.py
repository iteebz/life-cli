from life.personas.base import build_prompt
from life.personas.kim import kim
from life.personas.pepper import pepper
from life.personas.roast import roast
